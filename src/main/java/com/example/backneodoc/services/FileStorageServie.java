...
public interface FileStorageServie {
   ...
   // public ResponseEntity<?> saveMultiple(MultipartFile[] uploadedFile, Set<String> tags, String dep);
	...
	void save(MultipartFile file, String customFilename);

	//public ResponseEntity<?> saveMultiple(MultipartFile[] uploadedFile, Set<String> tags, String dep, String name);

	public ResponseEntity<?> saveMultiple(MultipartFile[] uploadedFile, Set<String> tags, Set<String> dep, String name);
